...
for line in content:
    ...
    '\n\n<Placemark>\n'
        ...
        '<LinearRing>\n'
        '<coordinates>\n' +
        str(coordinates_bg[0]) + ',' + str(coordinates_bg[1]) + ',10000\n' +
        str(coordinates_hg[0]) + ',' + str(coordinates_hg[1]) + ',10000\n' +
        str(coordinates_hd[0]) + ',' + str(coordinates_hd[1]) + ',10000\n' +
        str(coordinates_bd[0]) + ',' + str(coordinates_bd[1]) + ',10000\n' +
        str(coordinates_bg[0]) + ',' + str(coordinates_bg[1]) + ',10000\n' +
